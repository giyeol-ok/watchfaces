#!/usr/bin/env bash
# snoopy1-moonswatch preview capture: a moon-phase sweep (+0/5/10/15/20/25 days)
# cropped to the disc window, plus an AOD screenshot.
set -e

APPLICATION_ID="com.giyeol.snoopy1moonswatch"
APK_PATH="snoopy1-moonswatch/build/outputs/apk/debug/snoopy1-moonswatch-debug.apk"
