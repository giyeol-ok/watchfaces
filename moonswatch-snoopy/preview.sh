#!/usr/bin/env bash
# moonswatch-snoopy specific preview capture: a moon-phase sweep (+0/5/10/
# 15/20/25 days) cropped to the disc window, plus an AOD screenshot. Other
# watch faces are not expected to have a moon phase - write your own
# preview.sh alongside this one, calling the shared
# .github/scripts/install_and_activate.sh helper first.
set -e

APPLICATION_ID="com.giyeol.moonwatch"
APK_PATH="moonswatch-snoopy/build/outputs/apk/debug/moonswatch-snoopy-debug.apk"
