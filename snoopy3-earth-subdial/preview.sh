#!/usr/bin/env bash
# snoopy3-earth-subdial preview capture: a moon-phase sweep (+0/5/10/15/20/25 days)
# cropped to the disc window, plus an AOD screenshot.
set -e

APPLICATION_ID="com.giyeol.snoopy3earthsubdial"
APK_PATH="snoopy3-earth-subdial/build/outputs/apk/debug/snoopy3-earth-subdial-debug.apk"
